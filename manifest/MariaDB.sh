...
mysql -u root -pondongoa -e "use config_generator; INSERT INTO webserver (root_path, index_files, error_page, error_page_path) VALUES ('/var/www/html', 'index.html index.htm', '404 Not Found', '/var/www/html/error.html'), ('/var/www/html', 'web.html TP.htm', '400 Not Found', '/var/www/html/error.html'); INSERT INTO reverse_proxy (strategy_method, server1_domain, server2_domain) VALUES ('@upstrem', 'server1.example.com', 'server2.example.com'), ('@upstraem', 'server1.univ-smb.com', 'server2.univ-savoie.com'); INSERT INTO load_balancer (app_path, proxy_bind, proxy_pass, webserver_id) VALUES ('/app', '127.0.0.1:8080', 'http://server1.example.com', 1), ('/app2', '192.168.141.1:8080', 'http://server6.ALEX.com', 2);"
